...
def upvote(post_id, email=None, user=None):
	...
	body = "Your post, \"" + p.subject + "\" was upvoted by " + user.email + ".<br /><hr /><br /> You can turn off these notifications in your <a href=\"http://" + BASE_URL + "/groups/" + p.group.name + "/edit_my_settings\">group settings</a>."
