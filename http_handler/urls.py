...
if WEBSITE == 'murmur':
    ...
    urlpatterns = patterns('',
         ...
         url(r'^blacklist', 'browser.views.blacklist_get'),
         url(r'^whitelist', 'browser.views.whitelist_get'),

        url(r'^approve', 'browser.views.approve_get'),
         url(r'^reject', 'browser.views.reject_get'),
