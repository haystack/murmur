...
var Sandbox = {
	...
	View : Backbone.View.extend({
		initialize: function(opts) {
			...
			this.placeholder = opts.placeholder || "# try search('From: Soya Park')";
		...
		update : function() {
			...
			var last_cmd = history[history.length - 1].command;
			var result = history[history.length - 1].result;

			$("<span class='result'>    Mmail is a collection of email. <br>Customize your Mmail then drag and drop to your Email engine editor!<br/></span>").prependTo(".output");
			// $("<span class='result'>    "+ result +"<br/></span>").prependTo(".output");
			// $("<span class='command'>"+ last_cmd +"<br/></span>").prependTo(".output");
			$("<span class='command'>"+ last_cmd +"<br/></span>").prependTo(".output");
			...
			// 			result :  "Mmail is a collection of email. <br>Customize your Mmail then drag and drop to your Email engine editor!" // this.toEscaped(command.result)
			// 		});
			// 	}, "", this)
		    ...
		    $('#example-select-all').on('click', function(){
		       ...
		       $('input[name="{0}"]'.format(this.name)).prop('checked', this.checked);
		    });
